...
export default function ParticleStyleEditor({ settings, onChange, busy }: { settings: MessageSettings; onChange: (value: MessageSettings) => void; busy: boolean }) {
  ...
  return <details className="advanced feature-section matter-settings"><summary>Bewegung & Atmosphäre <span>Physik der Nachricht</span></summary><div className="feature-content">
