...
export default function SceneControls({ player, stage, slide, engine, useFallbackSecrets = false }: { player: ScenePlayer | null; stage: PlaybackStage; slide: Slide; engine: OneLineEngine | null; useFallbackSecrets?: boolean }) {
